...
- [Project setup](sanity/project-setup.md)
- [Dataset import/export](sanity/dataset-migration.md)
- [Studio structure](sanity/studio-and-structure.md)
...
- [Content architecture principles](architecture/content-architecture.md) — distilled from `sanity.md`
- [Agent guide](../AGENTS.md) — read this before making changes
